       ...
       <div>
        ...
        <div className="h-screen flex w-full flex-col lg:flex-row">
            <div className=" flex-1 m-1 sm:m-5 p-2 sm:m-10 mb-20 sm:mb-0 pl-5 lg:pl-10">
                <h1 className="ml-2 lg:ml-20 mb-2 text-5xl mt-10 lg:mt-20 text-gray-700 font-bold">Build Impactful and scaleable products </h1>
                <p className="ml-2 lg:ml-20 mb-5 text-lg w-2/3 lg:w-96">We are a future focused compay that aims to build a better africa by solving problems businesses and people face with technology</p>
        ...
        <div className="mb-5 w-full">
            <div className="w-full flex justify-center flex-column">
                <h1 className="text-5xl text-gray-700 font-bold text-center">About Us</h1>
            </div>
            <div className="w-full flex flex-row flex-wrap p-5 pt-5 justify-center">
               <p className="text-gray-700 text-center w-full lg:w-1/2 m-2">We are a future focused agency with a desire to utilize the positive power of technology to assist individuals, businesses and governments to achieve more, our expertise cut across software development, product design, business consultancy and so so much more.  </p>
            </div>
        </div>
        {/* what we do */}
        ...
        <div className="m-2 lg:h-screen w-full">
            ...
            <div className="flex flex-row flex-wrap p-5 lg:p-20 justify-center" >
